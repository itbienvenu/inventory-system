...
<body class="p-4">
  <div class="container">
    ...
    <table id="lowStockTable" class="table table-bordered table-striped">
      <thead>
        <tr><th>Product</th><th>SKU</th><th>Qty</th><th>Threshold</th><th>Supplier</th></tr>
      </thead>
      <tbody>
  ...
  <script>
    $(function(){
      console.log("jQuery document ready for Low Stock Products. Attempting to initialize DataTable...");
      ...
      console.log("DataTable initialization attempt complete for Low Stock Products.");
    });
  </script>
</body>
</html>
