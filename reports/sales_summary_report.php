...
<body class="p-4">
  ...
  <script>
    $(function(){
      console.log("jQuery document ready for Sales Summary. Attempting to initialize DataTable...");
      ...
      console.log("DataTable initialization attempt complete for Sales Summary.");
    });
  </script>
</body>
</html>
