                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="user-data m-b-30">
                                        ...
                                        <div class="table-responsive table-data" id="users">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_array($get_users)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="edit">
                                                                    <a href="../edits/edit_user.php?id=<?php echo $row['id'] ?>">
                                                                ...
                                                                <span class="delete">
                                                                    <a style="color: red;"
                                                                        href="../edits/delete_user.php?id=<?php echo $row['id'] ?>">
                                                                        <i class="zmdi zmdi-delete"></i> </a></span>
                                                                </span>
                                                                <span>
                                                                    <a style="color: orangered; "
                                                                        href="../edits/view_user.php?id=<?php echo $row['id']; ?>">
